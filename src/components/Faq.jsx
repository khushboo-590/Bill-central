                        ...
                        {FaqData.map((item, index) => (
                            <div
                                ...
                                <button onClick={() => toggleFAQ(index)} className="w-full text-left  p-[24px] flex justify-between items-center">
                                    ...
                                    {openIndex === index ? <img src={minus} alt="Collapse" className="transition-transform duration-300 transform  cursor-pointer" /> : <img src={plus} alt="Expand" className="transition-transform duration-300 transform cursor-pointer" />}
                                </button>
                                {openIndex === index && (
