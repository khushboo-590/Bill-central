...
const Header = () => {
    ...
    return (
        <section className='bg-[url(./assets/images/png/blue-img.png)] bg-cover bg-center lg:h-[810px] md:rounded-bl-[100px] lg:rounded-bl-[200px] h-none p-4'>
            <Navbar />
            <div className='conatiner max-w-[1140px] mx-auto flex flex-col items-center justify-center  ' data-aos="zoom-in-up">
                <div className=' grid grid-cols-1 md:grid-cols-2 gap-6'>
                    ...
                    <img src={dots} alt="Header Image" className=' absolute right-[-60px] mt-[53px] hidden xl:block z-0 ' />
